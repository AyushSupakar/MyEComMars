...
export default function Page() {
  ...
  return (
    <MyLayout>
      ...
      <div className='xshdw m-4 w-5/6 p-4'>
            ...
            <div className=" m-2 py-4 px-2">
              ...
              <div className=" flex  items-center font-sans text-lg ">
                <div className="flex w-1/3">
                  <span className='font-bold text-lg '>{each._id}</span>
                </div>
               <div className="flex items-center w-1/3  px-2 font-bold "><span className='font-bold text-xl'>
                    <span className='font-bold text-lg'>Ordered On: </span>{((each?.time).toString()).slice(0,10)}
                  </span></div>

                  <div className="flex w-1/6 justify-center">
                  <span className='font-bold text-lg'>{(each.paid)?("Paid"):("Not Paid")}</span>
                </div>

                <div className="flex w-1/6 justify-end"><Link className="btn-primary flex items-center justify-center rounded-lg  text-center font-bold cbg-green-900 text-white" href={'/orders/odetails/'+each._id}><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 7C12.5523 7 13 7.44772 13 8V13C13 13.5523 12.5523 14 12 14C11.4477 14 11 13.5523 11 13V8C11 7.44772 11.4477 7 12 7Z" fill="#ffffff"></path> <path d="M12 17C12.5523 17 13 16.5523 13 16C13 15.4477 12.5523 15 12 15C11.4477 15 11 15.4477 11 16C11 16.5523 11.4477 17 12 17Z" fill="#ffffff"></path> <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12Z" fill="#ffffff"></path> </g></svg></Link></div>
