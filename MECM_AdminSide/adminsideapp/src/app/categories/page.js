          ...
          <table>
            <thead>
              <tr>
                ...
                <td className="text-center border-2 cborder-blue-900 " >Parent Categories</td>
            ...
            <tbody>
              {allcats.map(eachcat => {
                return (
                  <tr className="border-2 cborder-blue-900 " key={eachcat._id}>
                    <td className=" text-center p-2 border-2 cborder-blue-900 " >{eachcat.catname}</td>
                    <td className=" text-center p-2 border-2 cborder-blue-900 " >{eachcat.parentcatname}</td>
                    <td className="  p-2 border-2 cborder-blue-900 ">
